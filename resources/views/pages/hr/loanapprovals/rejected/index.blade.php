<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="flex justify-between relative items-center mb-4">
            <h1 class="text-2xl md:text-2xl text-slate-800 dark:text-slate-100 font-bold lg:px-4">Reaaaaaaajected Loans</h1>
        ...
        <div class="sm:flex sm:justify-between sm:items-center">
            ...
            <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                ...
                <button class="btn bg-indigo-500 hover:bg-indigo-600 text-white">
                    ...
                    <span class="hidden xs:block ml-2">Addssssssssssss View</span>
                </button>
